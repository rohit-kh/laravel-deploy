...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('assets/css/dropify.min.css?v='.$v) }}">
...
<script src="{{ URL::asset('assets/js/dropify.min.js?v='.$v) }}"></script>
<script src="{{ URL::asset('assets/js/product-form.js?v='.$v) }}"></script>
</body>
<script>
